        ...
        this.dmxTestsGroupHtml = `
            <div class="group">
                ...
                <div class="group-content">
                    ...
                    <div id="speedRadial" min="1" max="100" step="1" lowValue="15" highValue="20" label="Radial Speed"></div>
                    ...
                    <div id="whiteScreenDuration" min="1" max="20" step="1" value="10" label="White Screen Dur"></div>
