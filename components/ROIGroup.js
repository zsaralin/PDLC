        ...
        this.roiGroupHtml = `
            <div class="group">
                ...
                <div class="group-content">
                    ...
                    <div id="segmentYOffset0" min="-100" max="100" step="1" value="10" label="Segment Y offset 0"></div>
                    <div id="segmentYOffset1" min="-100" max="100" step="1" value="10" label="Segment Y offset 1"></div>
                    <div id="segmentFeather" min="0" max="15" step="1" value="1" label="Segment Feather"></div>
                    
                    <div id="pushFactor" min="0" max="25" step="1" value="8" label="Push Factor"></div>
                    ...
                    <div id="armMultiple" min="0" max="10" step="1" value="1" label="Arm Multiple"></div>
