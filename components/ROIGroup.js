        ...
        this.roiGroupHtml = `
            <div class="group">
                ...
                <div class="group-content">
                    ...
                    <div id="roiX1" min="0" max="10" step=".1" value=".8" label="ROI x 1"></div>
                    <div id="roiY1" min="0" max="10" step=".1" value=".8" label="ROI x 1"></div>

                    <div id="roiXOffset0" min="-100" max="100" step="1" value="45" label="ROI X offset 0"></div>
                    ...
                    <div id="roiYOffset1" min="-100" max="2" step="1" value="-40" label="ROI Y offset 1"></div>
                    ...
                    <div id="pushFactor0" min="0" max="50" step="1" value="33" label="Push Factor 0"></div>
                    <div id="pushFactor1" min="0" max="50" step="1" value="8" label="Push Factor 1"></div>

                    <div id="pushLeft" min="0" max="15" step=".1" value="2" label="Push Left (canvas width / x)"></div>
                    <div id="pushRight" min="0" max="15" step=".1" value="2.8" label="Push Right (canvas width / x)"></div>
